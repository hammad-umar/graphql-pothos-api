...
export default class FieldBuilder<Types extends SchemaTypes, ParentShape, Kind extends FieldKind = FieldKind> extends RootFieldBuilder<Types, ParentShape, Kind> {
    ...
    ]>): import("..").FieldRef<import("..").ShapeFromTypeParam<Types, ["Boolean"], Nullable>, Kind>;
    /**
    ...
    ]>): import("..").FieldRef<import("..").ShapeFromTypeParam<Types, ["Float"], Nullable>, Kind>;
    /**
    ...
    ]>): import("..").FieldRef<import("..").ShapeFromTypeParam<Types, ["ID"], Nullable>, Kind>;
    /**
    ...
    ]>): import("..").FieldRef<import("..").ShapeFromTypeParam<Types, ["Int"], Nullable>, Kind>;
    /**
    ...
    ]>): import("..").FieldRef<import("..").ShapeFromTypeParam<Types, ["String"], Nullable>, Kind>;
    /**
    ...
    ]>): import("..").FieldRef<import("..").ShapeFromTypeParam<Types, FieldOptionsFromKind<Types, ParentShape, Type, Nullable, {}, Kind, ParentShape, ResolveReturnShape>["type"], (false & (Type extends [unknown] ? Awaited<ParentShape[Name]> extends readonly (infer T)[] | null | undefined ? [T] extends [NonNullable<T>] ? (readonly T[] | null | undefined) & Awaited<ParentShape[Name]> extends readonly T[] & Awaited<ParentShape[Name]> ? boolean | {
        items: boolean;
        list: boolean;
    } : true | {
        items: boolean;
