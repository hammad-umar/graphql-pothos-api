...
export default class FieldBuilder<Types extends SchemaTypes, ParentShape, Kind extends FieldKind = FieldKind> extends RootFieldBuilder<Types, ParentShape, Kind> {
    ...
    ]>): import("../index.js").FieldRef<import("../index.js").ShapeFromTypeParam<Types, [
        "Boolean"
    ], Nullable>, Kind>;
    /**
    ...
    ]>): import("../index.js").FieldRef<import("../index.js").ShapeFromTypeParam<Types, FieldOptionsFromKind<Types, ParentShape, Type, Nullable, {}, Kind, ParentShape, ResolveReturnShape>["type"], (false & (Type extends [
        unknown
